            ...
            <div className='flex flex-row mx-8 h-[20%] w-[75%]'>
                <div className='w-[50%] flex flex-col justify-center'>
                    <div className='text-center flex flex-col items-center'>
                        ...
                        <a href='mailto:kaushal2m2@gmail.com' target="_top" className='cursor-pointer'>
                        ...
                        <a href="https://www.linkedin.com/in/kaushal-marimuthu/" className="cursor-pointer">
                        ...
                        <a href="https://github.com/kaushal2m2/" className="cursor-pointer">
